...
public abstract class Mamifero {
    ...
    protected Pais pais;  //faltaba pais


    protected Mamifero(TipoAlimentacion tipoAlimentacion,
                       int edad, double peso, Especie especie, Sector sector, Pais pais) throws IllegalArgumentException, InvalidPropertiesFormatException {  //faltaba pais
