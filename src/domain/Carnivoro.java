...
public class Carnivoro extends Mamifero {
    ...
    public Carnivoro(int edad, double peso, Especie especie, Sector sector, Pais pais) throws InvalidPropertiesFormatException {// falta pais
        super(TipoAlimentacion.CARNIVORO, edad, peso, especie, sector, pais); // falta la caracteristica pais
    }
    ...
    public double calcularCantidadDeComida() {
        ...
        double comida = peso * especie.getPorcentajePesoCarnivoro() * ( 1 + porcentajeASumar);// no puede ser cero
        return comida;
    }
}
